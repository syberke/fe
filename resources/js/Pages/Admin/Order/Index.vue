                        ...
                        <div class="overflow-x-auto">
                            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                ...
                                <tr v-for="(order, i) in orders.data" class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3">
                                        <span v-if="order.status == 'Paid'" class="bg-gray-100 text-gray-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-gray-900 dark:text-gray-300">Paid</span>
                                    ...
                                    <td class="px-4 py-3 flex items-center justify-end">
                                        <Link v-if="order.status == 'Paid'" :href="route('admin.order.invoice', order.id)" class="inline-flex font-bold bg-gray-500 hover:bg-gray-600 rounded-lg px-2 py-1 text-white">
