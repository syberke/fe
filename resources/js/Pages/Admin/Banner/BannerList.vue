                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tr v-for="(item, index) in banners.data" :key="item.id" class="border-b dark:border-gray-700">
                            ...
                            <td class="px-4 py-3">
                                <td class="px-4 py-3">
                                    <span v-if="item.isActive == 1" class="bg-gray-100 text-gray-800 flex w-20 justify-center items-center text-xs font-medium me-2 px-2 py-1 rounded dark:bg-gray-900 dark:text-gray-300">Active</span>
